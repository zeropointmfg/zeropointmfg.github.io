...
// Variables to track the state for each button
...
document.getElementById('cnc_mill_btn').addEventListener('click', function () {
	// Change content based on button 1 click
	...
	readMoreLink1.href = 'pages/services/milling.html'; // Update the link href if needed
	toggleVisibility('cnc_mill_btn');
});

document.getElementById('cnc_turn_btn').addEventListener('click', function () {
	// Change content based on button 2 click
	contentText1.textContent =
	...
	readMoreLink1.href = 'pages/services/turning.html'; // Update the link href if needed
...
document
	...
	.addEventListener('click', function () {
		// Change content based on button 3 click
		contentText1.textContent =
		...
		readMoreLink1.href = 'pages/services/laser-etching.html'; // Update the link href if needed
		toggleVisibility('laser_etch_btn');
	});

document.getElementById('laser_cut_btn').addEventListener('click', function () {
	// Change content based on button 4 click
	contentText1.textContent =
	...
	readMoreLink1.href = 'pages/services/laser-cutting.html'; // Update the link href if needed
	toggleVisibility('laser_cut_btn');
});

document.getElementById('waterjet_btn').addEventListener('click', function () {
	// Change content based on button 5 click
	contentText1.textContent =
	...
	readMoreLink1.href = 'pages/services/waterjet-cutting.html'; // Update the link href if needed
	toggleVisibility('waterjet_btn');
});

document.getElementById('weld_btn').addEventListener('click', function () {
	// Change content based on button 6 click
	...
	readMoreLink2.href = 'pages/services/welding.html'; // Update the link href if needed
...
document
	...
	.addEventListener('click', function () {
		// Change content based on button 7 click
		contentText2.textContent =
		...
		readMoreLink2.href = 'pages/services/sheet-bending.html'; // Update the link href if needed
		toggleVisibility('sheet_bend_btn');
	});

document.getElementById('cad_btn').addEventListener('click', function () {
	// Change content based on button 8 click
	contentText2.textContent =
	...
	readMoreLink2.href = 'pages/services/cad.html'; // Update the link href if needed
	toggleVisibility('cad_btn');
});

document.getElementById('anodizing_btn').addEventListener('click', function () {
	// Change content based on button 9 click
	contentText2.textContent =
	...
	readMoreLink2.href = 'pages/services/anodizing.html'; // Update the link href if needed
...
document
	...
	.addEventListener('click', function () {
		// Change content based on button 10 click
		contentText2.textContent =
		...
		readMoreLink2.href = 'pages/services/powder-coating.html'; // Update the link href if needed
		toggleVisibility('powder_coat_btn');
	});

// Function to toggle the visibility of the hidden row for each button
